...
const HomeComp = ({ headerChange, match, language, countOfLike, firebase, ...props }) => {
  ...
  return (
    <>
      <Header countOfLike={count} setLike={setLike} />
      <main>
        <div className="row">
          <h4 className="homeSectionH4">{dictionary[language].main.topText}</h4>
          <ul className="anchorWorkCompany">
            <li>
              <AnchorLink href="#AET">AET Groupe</AnchorLink>
            </li>
            <li>
              <AnchorLink href="#Webmatrix">Webmatrix</AnchorLink>
            </li>
            <li>
              <AnchorLink href="#LTD">Business Solution LTD</AnchorLink>
            </li>
            <li>
              <AnchorLink href="#Software">Software Business Technology</AnchorLink>
            </li>
          </ul>
          <div className="homeSection">
            ...
            <section id="AET">
              ...
              <p>
                {dictionary[language].main.workPeriodLabel +
                  dictionary[language].main.aetPeriod}
              </p>
              ...
              <ul className="technologyList">
                ...
                <li className="siteLink">
                  <a target="_blank" href="http://www.5d.by/new/">
                    http://www.5d.by/new/
                  </a>
                </li>
              </ul>
            ...
            <section id="Webmatrix">
              ...
              <p>
                {dictionary[language].main.workPeriodLabel +
                  dictionary[language].main.webmatrixPeriod}
              </p>
              <p>{dictionary[language].main.learn}</p>
              <ul className="technologyList">
                <li>MYSQL</li>
                ...
                <li>PHP</li>
                <li className="siteLink">
                  <a target="_blank" href="http://autotechnology.by/">
                    http://autotechnology.by
                  </a>
                </li>
              </ul>
            </section>
            ...
            <section id="LTD">
              ...
              <p>
                {dictionary[language].main.workPeriodLabel +
                  dictionary[language].main.ltdPeriod}
              </p>
              <p>{dictionary[language].main.learn}</p>
              <ul className="technologyList">
                <li>Laravel</li>
            ...
            <section id="Software">
              ...
              <p>
                {dictionary[language].main.workPeriodLabel +
                  dictionary[language].main.softwarePeriod}
              </p>
              <p>{dictionary[language].main.learn}</p>
              <ul className="technologyList">
                <li>React JS</li>
